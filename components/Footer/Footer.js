  ...
  return (
    <div className="h-auto mt-2 ">
      <div className="flex justify-center gap-4 pb-5">
        <AiOutlineTwitter className="text-[20px] text-white" />
      ...
      <div className="px-5">
        ...
        {/* <div className="flex pb-5 text-[#707070] text-[14px] justify-around md:justify-center md:gap-11">
          <p>Terms</p>
          <p>Privacy</p>
          <p>Disclosures</p>
          <p>Advertise</p>
        </div> */}
        <div className="flex pb-5 text-[#707070] text-[14px] justify-around md:justify-center md:gap-20">
          <p>Terms</p>
          <p>Privacy</p>
          <p>Disclosures</p>
